...
<a href="table3.php">Upcoming Birthdays</a>
<?php
...
if ($result1->num_rows > 0)
{
	while($row1 = $result1->fetch_assoc())
	{
		...
		<input type="hidden" name="username" value="<?php echo $a1; ?>">
		<input type="hidden" name="password" value="<?php echo $a2; ?>">
		<input type="submit" value="upcoming birthdays">
		</form>
		<?php
	}
